...
public class TextureData : UpdatableData
{
    ...
    {
        Texture2DArray textureArrary = new Texture2DArray(textureSize, textureSize, textures.Length, textureFormat, true);
        for (int i = 0; i < textures.Length; i++)
        {
            textureArrary.SetPixels(textures[i].GetPixels(), i);
        }
        textureArrary.Apply();
        return textureArrary;
    }
